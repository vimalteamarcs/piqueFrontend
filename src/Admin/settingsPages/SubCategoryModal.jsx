...
// export default function SubCategoryModal({ mainCategoryId, fetchSubCategories, show, handleClose, showToast }) {
...
export default function SubCategoryModal({
  ...
  const handlesubSubmit = async (e) => {
    ...
    try {
      ...
      // Show the toast after modal closes
      setTimeout(() => {
        showToast("Sub-category created successfully!", "success");
      }, 2000);
      ...
      setTimeout(() => {
        handleClose();
        setError(""); // Clear the error after closing the modal
      }, 2000);
    }
  };
        ...
        {mainCategoryId ? (
          <Form onSubmit={handlesubSubmit} className="align-items-center">
            ...
            <Button
              variant="danger"
              onClick={handleClose}
              className="btn rounded-3 mt-3 btn-sm float-end ms-2"
            >
              Close
            </Button>
            <Button
              ...
              variant="dark"
              size="sm"
              className="btn rounded-3 mt-3 float-end"
            >
              Add Subcategory
            </Button>
          </Form>
